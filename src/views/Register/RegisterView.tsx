          ...
          >
            ...
            <Formik
              ...
              onSubmit={async (values, { setSubmitting }) => {
                const key = Object.keys(Rol).find(
                  (k) => Rol[k as keyof typeof Rol] === values.rol
                );
                ...
                const usuarioCreado = await register(usuario);
                  ...
                  <Grid container spacing={3}>
                    ...
                    <Grid size={12}>
                      ...
                      <TextField
                        ...
                        sx={{
                          "& .MuiFormHelperText-root": { color: "#ffb0b0" },
                        }}
                      />
                    </Grid>
                    <Grid size={12}>
                    ...
                    <Grid size={12}>
                      ...
                      >
                        <InputLabel id="rol-label" sx={{ color: "#b0b0b0" }}>
                          Rol
                        </InputLabel>
                        <Select
                          labelId="rol-label"
                      ...
                      <Autocomplete
                        ...
                        renderInput={(params) => (
                          <TextField
                            ...
                            variant="outlined"
                            error={
                              touched.sucursalEmpresa &&
                              Boolean(errors.sucursalEmpresa)
                            }
                            helperText={
                              touched.sucursalEmpresa && errors.sucursalEmpresa
                                ? "La sucursal es requerida para este rol"
                                : null
                            }
                            InputLabelProps={{ style: { color: "#b0b0b0" } }}
                            InputProps={{
                          ...
                          <>
                            ...
                            <Grid size={{ xs: 12, sm: 4 }}>
                              <TextField
                                ...
                                value={
                                  values.domicilio.numero === 0
                                    ? ""
                                    : values.domicilio.numero
                                } // Handle 0 for empty field
                                onChange={handleChange}
                                onBlur={handleBlur}
                                error={
                            ...
                            <Grid size={{ xs: 12, sm: 4 }}>
                              <TextField
                                ...
                                onBlur={handleBlur}
                                error={
                                  touched.domicilio?.cp &&
                                  Boolean(errors.domicilio?.cp)
                                }
                                InputLabelProps={{
                                  style: { color: "#b0b0b0" },
                                }}
                            ...
                            <Grid size={{ xs: 12, sm: 4 }}>
                              <TextField
                                ...
                                onBlur={handleBlur}
                                error={
                                  touched.domicilio?.localidad?.nombre &&
                                  Boolean(errors.domicilio?.localidad?.nombre)
                                }
                                InputLabelProps={{
                                  style: { color: "#b0b0b0" },
                                }}
                            ...
                            <Grid size={{ xs: 12, sm: 4 }}>
                              <TextField
                                ...
                                label="Provincia"
                                value={
                                  values.domicilio.localidad.provincia.nombre ||
                                  ""
                                }
                                onChange={handleChange}
                                onBlur={handleBlur}
                                error={
                                  touched.domicilio?.localidad?.provincia
                                    ?.nombre &&
                                  Boolean(
                                    errors.domicilio?.localidad?.provincia
                                      ?.nombre
                                  )
                                }
                                InputLabelProps={{
                            ...
                            <Grid size={{ xs: 12, sm: 4 }}>
                              <TextField
                                ...
                                onBlur={handleBlur}
                                error={
                                  touched.domicilio?.localidad?.provincia?.pais
                                    ?.nombre &&
                                  Boolean(
                                    errors.domicilio?.localidad?.provincia?.pais
                                      ?.nombre
                                  )
                                }
                                InputLabelProps={{
